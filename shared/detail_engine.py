    ...
    dm = {
        ...
        "DM-3": [
            ...
            DetailSection(title="配音质量检查", source="computed", items=[
                ...
                EntityItem("aq_bgm","背景音效","✅ SFX 已集成: freesound.org 10集音效配置 · --sfx 启用混音 → final_with_sfx.aac","real",
                    "","","ok","EP01-10 全量 EPISODE_SFX 配置 · 风雪/虎啸/喧哗/刀剑/木材/脚步/鸟鸣/水声/柴火/拳击"),
        ...
        "DM-F": [
            DetailSection(title="管线步骤状态", source="real", items=[
                ...
                EntityItem("pf_sfx","Step 2.5: 环境音效","✅ 已集成 freesound.org · 10集全量 EPISODE_SFX 配置 · --sfx 启用","real",
                    "","","ok","风雪/虎啸/喧哗/刀剑/木材/脚步/鸟鸣/水声/柴火/拳击 共11类"),
